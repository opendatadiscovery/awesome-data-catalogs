...
| Dawiso                             | Dawiso                                              | Prop          | -                                                           | [dawiso.com](https://www.dawiso.com)                                      | ✔️                                       | ✔️                                   | ✔️               | ✔️                       | ✔️                                    | ✔️                       | ✔️                   | ✔️                                             | ✔️                                         | ❌                     | ❌                    | ❌             | ❌          |
...
Dawiso is a proprietary data governance and AI platform that helps organizations discover, manage, and govern their data assets. It provides automatic metadata scanning, AI-powered enrichment, interactive data lineage, and business glossary management. The platform supports 40+ data platform connectors and offers MCP (Model Context Protocol) support for AI agents integration.
...
<li><b>Network-based:</b> Yes</li>
<li><b>Rich data profiling:</b> Yes</li>
<li><b>Supported data sources:</b> 40+ connectors including databases, data warehouses, BI tools, and cloud platforms</li>
</ul>
</details>
